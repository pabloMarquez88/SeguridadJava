    ...
    extends Service
{
    ...
    private final static QName MYWEBSERVICESERVICE_QNAME = new QName("http://service.globinch.com/", "MyWebServiceService");
    ...
    public MyWebService getMyWebServicePort() {
        return super.getPort(new QName("http://service.globinch.com/", "MyWebServicePort"), MyWebService.class);
    }
    ...
    public MyWebService getMyWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.globinch.com/", "MyWebServicePort"), MyWebService.class, features);
    }
